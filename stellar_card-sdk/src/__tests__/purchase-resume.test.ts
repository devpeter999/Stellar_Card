// Unit tests for the CLI `stellar_card purchase --resume` state machine.
//
...
beforeEach(() => {
  tmpDir = fs.mkdtempSync(path.join(os.tmpdir(), 'stellar_card-resume-test-'));
...
//
// This suite spies on checkSorobanTxLanded + Stellar_CardClient to drive
