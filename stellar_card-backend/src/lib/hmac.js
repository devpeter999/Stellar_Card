// @ts-check
// Shared HMAC sign + verify for the vcc ↔ stellar_card callback channel.
//
 ...
 *
 * The nonce is a per-job UUID generated by stellar_card at invoice time and
 * stored on both the order (stellar_card) and the job (vcc). Including it in
