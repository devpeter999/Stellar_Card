...
//
// Why: the stellar_card ↔ vcc ↔ CTX ↔ scraper pipeline has a lot of
...
const RULES = Object.freeze([
  ...
  // CTX paid but card not extracted — incident 2026-04-29. stellar_card
