...
// URI). Branching:
//
//   - If the agent paid stellar_card in XLM, we just forward XLM from the
//     treasury (the agent's payment already landed there).
//   - If the agent paid stellar_card in USDC and the order is >= the micro
...
//   - If the agent paid stellar_card in USDC but the order is below the
