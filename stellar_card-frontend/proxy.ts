...
//      cookie themselves.
//
//   2. status.stellar_card.com subdomain — everything under this host
...
const STATUS_HOST = 'status.stellar_card.com';
...
export const config = {
  // Match everything under status.stellar_card.com except the Next.js
  // asset pipeline. The main apex host (stellar_card.com) hits the
  ...
  matcher: [
    {
      ...
      has: [{ type: 'header', key: 'host', value: 'status.stellar_card.com' }],
    },
  ],
};
