...
export const metadata: Metadata = {
  ...
  description:
    "What Stellar_Card collects, what it doesn't, who processes it, and how long we keep it. Written in plain English.",
  alternates: { canonical: 'https://stellar_card.com/privacy' },
};
  ...
  return (
    <>
      <PageHero
        ...
        accent="what"
        intro="Stellar_Card is a transaction-processing company. The data we hold is the data we need to reconcile a payment against a card order, plus the bare minimum to sign you in. Nothing else."
      />

      <LegalBody
        intro={
          <>
            <strong>Last updated 14 April 2026.</strong> Stellar_Card is operated by CTX.com Inc. We
            ...
            body: (
              <>
                <ul>
                  ...
                  <li>
                    <strong>No cardholder PII.</strong> Cards are issued by Pathward. Stellar_Card
              ...
              <>
                ...
                <ul>
                  ...
                  <li>
                    ...
                    Stellar_Card does not control this data and cannot delete it.
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    centre). Stellar_Card operates on dedicated cloud instances under our own control.
                  </li>
                </ul>
                <p>
          ...
          },
          {
            ...
            body: (
              <>
                ...
                <p>
                  Email <a href="mailto:privacy@stellar_card.com">privacy@stellar_card.com</a> with any of
            ...
            body: (
              <>
                ...
                <p>
                  ...
                  <a href="mailto:privacy@stellar_card.com">privacy@stellar_card.com</a>
                </p>
              </>
            ),
          },
