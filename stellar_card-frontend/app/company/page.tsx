...
export const metadata: Metadata = {
  title: 'Company',
  description:
    "Stellar_Card is a small team building payment infrastructure for AI agents. Here's who we are and where we're going.",
  alternates: { canonical: 'https://stellar_card.com/company' },
  openGraph: ogForPage({
    title: 'Company — Stellar_Card',
...
const PRINCIPLES = [
  ...
  },
  {
    ...
    body: 'Stellar_Card does one job: turn a Stellar payment into a Visa card. We will not bolt on a rewards programme, a fiat on-ramp, or a chat widget. Depth over breadth, forever.',
  },
  {
    title: 'Write it down.',
...
const MILESTONES = [
  ...
  },
  {
    ...
    body: 'Agents now pay the receiver contract directly. Claude Desktop integration via the Stellar_Card MCP server.',
    status: 'Shipped',
  },
  {
    date: 'Q3 2026',
  ...
  },
  {
    ...
    body: 'European IBAN accounts for agents that need a non-card rail. Transparent on-chain reporting of Stellar_Card treasury flow.',
    status: 'Planned',
  },
];
  ...
  return (
    <>
      <PageHero
        ...
        accent="agents"
        intro="Stellar_Card was started because there was no way for an LLM agent to buy something on the open internet without a human holding its hand. Not without pasting a card number into a chat. Not without a human approving every transaction. Not without giving up custody. We're fixing that — carefully, one primitive at a time."
      />
      ...
      <PageSection>
        ...
        >
          ...
          <div>
            ...
            <p className="type-body" style={{ fontSize: '1rem', marginBottom: '1.2rem' }}>
              Stellar_Card is the middle answer. A stablecoin payment in, a real card out, and a
      ...
      <section style={{ padding: '3rem 1.35rem 6rem' }}>
        ...
        >
          ...
          >
            {[
              ['General', 'hello@stellar_card.com'],
              ['Careers', 'careers@stellar_card.com'],
              ['Press', 'press@stellar_card.com'],
              ['Partnerships', 'partners@stellar_card.com'],
            ].map(([label, email]) => (
              <div key={label}>
                <div
