...
const POST_URL = 'https://stellar_card.com/blog/sse-beats-polling-for-agent-apis';
...
export const metadata: Metadata = {
  ...
  openGraph: ogForPage({
    title: 'Why SSE beats polling for agent-facing APIs — Stellar_Card',
    description:
    ...
    <>
      ...
      >
        ...
        <div className="post-body">
          <p className="lede">
            When Stellar_Card launched, <code>GET /v1/orders/:id</code> was the only way to watch an
          ...
          <p>
            <strong>Delivery semantics need work.</strong> Stellar_Card webhooks are retried with
          ...
          <ul>
            ...
            <li>
              <strong>Resumable.</strong> Every SSE event from Stellar_Card carries the full current
          ...
          <p>
            If you&apos;re integrating Stellar_Card and for whatever reason SSE isn&apos;t available — a
          ...
          <p>
            ...
            <Link href="/blog/anatomy-of-a-stellar_card-order">anatomy of a Stellar_Card order</Link>, and
