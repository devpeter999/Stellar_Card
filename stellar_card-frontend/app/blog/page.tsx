...
export const metadata: Metadata = {
  title: 'Blog',
  description:
    'Engineering-honest writing from the Stellar_Card team. Architecture, incidents, and what we learned building payment rails for AI agents.',
  alternates: { canonical: 'https://stellar_card.com/blog' },
  openGraph: ogForPage({
    title: 'Blog — Stellar_Card',
    description:
      'Engineering-honest writing from the Stellar_Card team. Architecture, incidents, and what we learned building payment rails for AI agents.',
    path: '/blog',
  }),
  twitter: twitterForPage({
    title: 'Blog — Stellar_Card',
    description: 'Engineering-honest writing from the Stellar_Card team.',
  }),
};
...
const PUBLISHED: Post[] = [
  ...
  },
  {
    ...
    excerpt:
      "Raw API keys aren't insecure — they're insecure when the operator is going to paste them into an LLM chat. Why Stellar_Card onboards agents with single-use claim codes, the threat model, and the exchange flow that avoids every credential-in-prompt failure we could think of.",
  ...
  },
  {
    ...
    excerpt:
      'Why Stellar_Card agents pay the receiver contract directly on Stellar, and how the backend watches on-chain events instead of touching customer funds. The trade-offs we accepted and the ones we refused.',
    tags: ['architecture', 'stellar'],
  },
  {
    date: '2026-04-14',
    slug: 'anatomy-of-a-stellar_card-order',
    title: 'Anatomy of a Stellar_Card order',
    excerpt:
    ...
    <>
      ...
      <section style={{ padding: '3rem 1.35rem 6rem' }}>
        ...
        >
          ...
          >
            If you&apos;ve built something interesting on top of Stellar_Card and want to write about
            it, we&apos;ll happily host it on the blog with full byline and a link to your work.
            Email{' '}
            <a
              href="mailto:press@stellar_card.com"
              style={{
                color: 'var(--fg)',
                textDecoration: 'none',
