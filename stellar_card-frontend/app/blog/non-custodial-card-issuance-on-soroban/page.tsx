...
const POST_URL = 'https://stellar_card.com/blog/non-custodial-card-issuance-on-soroban';
const POST_DATE = '2026-04-14';

export const metadata: Metadata = {
  title: 'How we built non-custodial card issuance on Soroban',
  description:
    'Why Stellar_Card agents pay the receiver contract directly on Stellar, and how the backend watches on-chain events instead of touching customer funds.',
  alternates: { canonical: POST_URL },
  openGraph: ogForPage({
    title: 'How we built non-custodial card issuance on Soroban — Stellar_Card',
    description:
      'Agents pay a Soroban receiver contract directly. Stellar_Card observes on-chain events and brokers fulfilment — funds never pass through our wallets.',
    path: '/blog/non-custodial-card-issuance-on-soroban',
  }),
  twitter: twitterForPage({
    title: 'How we built non-custodial card issuance on Soroban',
    description:
      'Agents pay the receiver contract directly. Stellar_Card watches on-chain events and brokers fulfilment.',
  }),
};
  ...
  itemListElement: [
    {
      ...
      position: 1,
      name: 'Blog',
      item: 'https://stellar_card.com/blog',
    },
    {
      '@type': 'ListItem',
      position: 2,
    ...
    <>
      ...
      >
        ...
        <div className="post-body">
          <p className="lede">
            The first version of Stellar_Card was custodial. An agent would send USDC to a
            Stellar_Card-controlled Stellar wallet, the backend would watch the ledger for deposits,
          ...
          <ul>
            ...
            <li>
              ...
              <code>order_id</code> so the backend knows exactly which Stellar_Card order the deposit
              belongs to — no heuristics, no memo field parsing, no timing windows to reconcile.
            </li>
          </ul>

          <h2>The receiver contract</h2>
          <p>The Stellar_Card receiver contract has two entry points:</p>
          ...
          <ol>
            ...
            <li>
              Looks up the matching Stellar_Card order row. If the order doesn&apos;t exist, we push the
          ...
          <p>
            ...
            from the Stellar_Card treasury wallet back to the agent. The refund transaction hash lands
          ...
          <p>
            ...
            <Link href="/status">status.stellar_card.com</Link> and the security page for the treasury
            public key.
          </p>
          ...
          <ol>
            ...
            <li>
              ...
              ledger without trusting Stellar_Card data at all.
            </li>
            <li>
            ...
            <li>
              <strong>Blast radius containment.</strong> A compromise of the Stellar_Card backend
          ...
          <p>
            ...
            cover the event model we rely on. The Stellar_Card-side details are in{' '}
            ...
            <Link href="/blog/anatomy-of-a-stellar_card-order">Anatomy of a Stellar_Card order</Link> walks
            through the full 33-second timeline in the other direction — from the agent&apos;s first
            API call through to the card landing.
          </p>

          <p>
            Questions on this? Email <a href="mailto:api@stellar_card.com">api@stellar_card.com</a>. We read
            every one.
          </p>
        </div>
