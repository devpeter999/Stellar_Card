...
const POST_URL = 'https://stellar_card.com/blog/anatomy-of-a-stellar_card-order';
...
export const metadata: Metadata = {
  ...
  openGraph: ogForPage({
    title: 'Anatomy of a Stellar_Card order — Stellar_Card',
    description: 'Every millisecond of the 33-second path from purchaseCard() to PAN-in-hand.',
    path: '/blog/anatomy-of-a-stellar_card-order',
  }),
...
const blogJsonLd = {
  ...
  headline: 'Anatomy of a Stellar_Card order',
  ...
  publisher: {
    ...
    logo: {
      '@type': 'ImageObject',
      url: 'https://stellar_card.com/icon.png',
    },
  },
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    },
    {
      '@type': 'ListItem',
      position: 2,
      name: 'Anatomy of a Stellar_Card order',
      item: POST_URL,
    },
  ],
};
    ...
    <>
      ...
      >
        ...
        <header style={{ marginBottom: '3rem' }}>
          ...
          >
            Anatomy of a Stellar_Card order.
          </h1>
          <div
            style={{
              display: 'flex',
        ...
        <div className="post-body">
          ...
          <p>
            ...
            the fact that Stellar_Card can hit that reliably is a function of every component in the
          ...
          <p>
            When Stellar_Card launched, <code>GET /v1/orders/:id</code> was the only way to watch order
          ...
          <p>
            If you&apos;re building on Stellar_Card and want to dig deeper, the full HTTP API reference
            ...
            <a href="mailto:api@stellar_card.com">api@stellar_card.com</a>.
          </p>
        </div>
