...
const POST_URL = 'https://stellar_card.com/blog/what-we-found-auditing-our-own-code';
...
export const metadata: Metadata = {
  ...
  openGraph: ogForPage({
    title: 'What we found auditing our own code — Stellar_Card',
    description:
    ...
    <>
      ...
      <article style={{ maxWidth: 720, margin: '0 auto', padding: '4.5rem 1.35rem 6rem' }}>
        ...
        <div className="post-body">
          <p className="lede">
            We ran a systematic adversarial audit of the entire Stellar_Card codebase over two days.
          ...
          <p>
            ...
            URL hardcoded instead of reading from the environment. Stellar_Card runs on mainnet in both
