...
const DESCRIPTION =
  'Stellar_Card sells Visa reward cards at face value — no signup fee, no markup. Only the standard issuer fees apply, listed in full on the page.';

export const metadata: Metadata = {
  title: 'Pricing',
  description: DESCRIPTION,
  alternates: { canonical: 'https://stellar_card.com/pricing' },
  openGraph: ogForPage({
    title: 'Pricing — Stellar_Card',
...
const FEE_ROWS = [
  {
    label: 'Stellar_Card service fee',
    value: '$0.00',
...
const FAQ = [
  {
    ...
    a: 'Stellar_Card makes money on volume discounts we negotiate with our card suppliers. When an agent buys a $25 card, we settle with the supplier at a rate slightly below $25 and pass the full face value through to the agent. We break even on every individual card and profit on aggregate flow. No surprise markup.',
  },
  {
    q: 'Do I pay Stellar network fees?',
    a: 'Yes. Each card purchase triggers a Soroban contract call from your agent wallet, which costs roughly 0.005–0.02 XLM (a fraction of a cent) in network fees depending on execution cost. Your wallet pays it directly — Stellar_Card never touches it.',
  },
  {
...
// Product schema for the pricing page itself. Positions Stellar_Card as
// a free service in Google's SERP UI when price filters are active.
const productJsonLd = {
  '@context': 'https://schema.org',
  '@type': 'Product',
  name: 'Stellar_Card — Virtual Visa cards for AI agents',
  description:
  ...
  brand: { '@type': 'Brand', name: 'Stellar_Card' },
  offers: {
    '@type': 'Offer',
    url: 'https://stellar_card.com/pricing',
    priceCurrency: 'USD',
    price: '0.00',
  ...
  return (
    <>
      ...
      <PageHero
        ...
        accent="markup"
        intro="Every Stellar_Card order settles exactly 1:1 against the card's USD face value. There is no subscription, no signup fee, and no per-transaction surcharge from us. The only fees you'll ever see are the ones the card issuer charges directly — listed in full below."
      />
      ...
      <PageSection background="surface">
        ...
        >
          ...
          >
            ...
            >
              Every Stellar_Card card is a Visa Reward Card issued by Pathward, N.A. pursuant to a
