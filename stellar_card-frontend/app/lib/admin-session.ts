// Server-only helpers for the stellar_card admin dashboard session.
//
...
export const ADMIN_SESSION_COOKIE = 'stellar_card_admin_session';
...
/**
 * Resolve the upstream stellar_card backend URL from env. Prefers
