...
export const metadata: Metadata = {
  ...
  description:
    'Summary of the Pathward, N.A. Visa Reward Card cardholder agreement that governs every card issued through Stellar_Card.',
  alternates: { canonical: 'https://stellar_card.com/legal/cardholder-agreement' },
};
  ...
  itemListElement: [
    {
      ...
      position: 1,
      name: 'Legal',
      item: 'https://stellar_card.com/terms',
    },
    {
      '@type': 'ListItem',
      position: 2,
      name: 'Cardholder agreement',
      item: 'https://stellar_card.com/legal/cardholder-agreement',
    },
  ],
};
  ...
  return (
    <>
      ...
      <PageHero
        ...
        intro={
          <>
            Every Stellar_Card card is a Visa® Reward Card issued by{' '}
            ...
            body: (
              <>
                <ul>
                  ...
                  <li>
                    <strong>Stellar_Card service fee:</strong> $0.00. Stellar_Card sells the card at face
          ...
          },
          {
            ...
            body: (
              <>
                ...
                <p>
                  For Stellar_Card-specific questions (API issues, order status, failed fulfilment),
                  contact <a href="mailto:support@stellar_card.com">support@stellar_card.com</a> directly —
