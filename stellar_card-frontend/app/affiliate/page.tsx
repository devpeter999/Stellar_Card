...
export const metadata: Metadata = {
  ...
  description:
    'Earn on every Stellar_Card card issued through your referral. Lifetime tracking, monthly Stellar payouts, white-label dashboard. Coming soon.',
  alternates: { canonical: 'https://stellar_card.com/affiliate' },
  openGraph: ogForPage({
    title: 'Affiliate program — Stellar_Card',
...
const PERKS = [
  {
    ...
    body: 'Earn 20% of the revenue Stellar_Card makes on every card issued by operators you referred, for the full lifetime of their account. Paid monthly in USDC or XLM, on-chain, auditable. No expiring cookies, no 30-day attribution window, no capped earnings.',
  },
  {
  ...
  },
  {
    ...
    body: 'Host your own sub-brand of the Stellar_Card onboarding experience with your logo, your colours, and a custom claim-code flow. Your referrals never see our domain.',
  },
  {
  ...
  return (
    <>
      <PageHero
        ...
        accent="earn"
        intro="We're building a first-class referral program for the platforms and people who bring operators to Stellar_Card. Generous, transparent, lifetime-tracked, paid in stablecoin. Here's what's coming and how to get early access."
      >
        {/* Status pill */}
        <div
          style={{
        ...
        >
          ...
          <div style={{ position: 'relative' }}>
            ...
            >
              Email{' '}
              <a
                href="mailto:affiliate@stellar_card.com?subject=Affiliate waitlist"
                style={{
                  color: 'var(--fg)',
