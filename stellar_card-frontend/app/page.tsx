...
const purchaseSnippet = `import { purchaseCardOWS } from 'stellar_card';
...
const FEATURES = [
  ...
  },
  {
    ...
    body: 'Stellar_Card never holds customer funds. The agent signs with its own OWS wallet; the backend only observes on-chain events and brokers fulfillment.',
  },
  {
  ...
  },
  {
    ...
    body: 'Drop the Stellar_Card MCP server into Claude Desktop, hit the REST API from any runtime, or subscribe to the SSE phase stream for live updates.',
  },
];

// SoftwareApplication JSON-LD. Stellar_Card is a dev-tool rather than a
...
const softwareAppJsonLd = {
  ...
  '@id': 'https://stellar_card.com#software',
  name: 'Stellar_Card',
  ...
  releaseNotes: 'https://stellar_card.com/changelog',
  featureList: [
      ...
      >
        ...
        >
          <div>
            ...
            >
              The Stellar_Card SDK wraps the order → Soroban payment → card-ready cycle behind a single
