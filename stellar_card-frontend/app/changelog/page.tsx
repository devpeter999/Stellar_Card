...
export const metadata: Metadata = {
  title: 'Changelog',
  description:
    'Everything shipped to Stellar_Card. API changes, dashboard polish, security fixes, and upstream-issuer updates — chronologically.',
  alternates: {
    canonical: 'https://stellar_card.com/changelog',
    ...
    types: {
      'application/rss+xml': 'https://stellar_card.com/changelog/feed.xml',
    },
  },
  openGraph: ogForPage({
    title: 'Changelog — Stellar_Card',
    description: 'Everything shipped to Stellar_Card, chronologically.',
    path: '/changelog',
  }),
...
const changelogJsonLd = {
  ...
  itemListElement: ENTRIES.map((e, i) => ({
    ...
    item: {
      ...
      description: e.body,
      url: `https://stellar_card.com/changelog#${e.date}-${slug(e.title)}`,
      author: { '@type': 'Organization', name: 'Stellar_Card' },
      publisher: {
        '@type': 'Organization',
        name: 'Stellar_Card',
        logo: {
  ...
  return (
    <>
      ...
      <PageHero
        ...
        accent="shipped"
        intro="Stellar_Card is a platform, so every change matters. This page is updated the same day a change lands in production. Security-sensitive fixes are disclosed here after the patch is out. Breaking API changes are always announced 30 days before they take effect."
      />
