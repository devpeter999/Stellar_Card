// Merchants — card grid of the gift-card products stellar_card has
...
export default function MerchantsPage() {
  ...
  return (
    <PageContainer>
      <PageHeader
        title="Merchants"
        subtitle="Gift card products Stellar_Card has onboarded. More are coming — contact support if you need a specific one enabled."
      />
