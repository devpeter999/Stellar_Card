...
// every AI-generated app ships with, and Stellar_Card should read as
...
const SITE_URL = 'https://stellar_card.com';
const SITE_NAME = 'Stellar_Card';
...
export const metadata: Metadata = {
  ...
  // "Pricing — Stellar_Card" so every tab has the brand without each
  ...
  authors: [{ name: 'Stellar_Card', url: SITE_URL }],
  creator: 'Stellar_Card',
  publisher: 'Stellar_Card',
  formatDetection: {
    email: false,
    address: false,
    telephone: false,
...
const jsonLdOrg = {
  ...
  description: SITE_DESCRIPTION,
  sameAs: ['https://x.com/stellar_card', 'https://github.com/CTX-com/Stellar_Card'],
  contactPoint: [
    {
      '@type': 'ContactPoint',
    ...
    },
    {
      '@type': 'ContactPoint',
      contactType: 'press',
      email: 'press@stellar_card.com',
    },
    {
      '@type': 'ContactPoint',
      contactType: 'security',
      email: 'security@stellar_card.com',
    },
  ],
};
...
export default async function RootLayout({
  ...
  // Suppress marketing chrome on the status.stellar_card.com subdomain.
  ...
  const isStatusSubdomain =
    host === 'status.stellar_card.com' || host.startsWith('status.stellar_card.com:');
