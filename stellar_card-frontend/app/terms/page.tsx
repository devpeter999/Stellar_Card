...
export const metadata: Metadata = {
  ...
  description:
    'The terms under which Stellar_Card provides the agent card-issuance API. Plain English, no dark patterns.',
  alternates: { canonical: 'https://stellar_card.com/terms' },
};
  ...
  return (
    <>
      <PageHero
        ...
        accent="English"
        intro="Stellar_Card is a developer tool. These terms describe what we provide, what we expect from you in return, and how the relationship can end. They are boring, deliberately."
      />

      <LegalBody
        intro={
          <>
            <strong>Last updated 14 April 2026.</strong> By using Stellar_Card you agree to these terms.
            If anything here is unclear, email{' '}
            <a href="mailto:legal@stellar_card.com">legal@stellar_card.com</a> and we&apos;ll clarify — both
            in email and on this page.
          </>
        }
        sections={[
          {
            heading: '1. What Stellar_Card provides',
            body: (
              <>
                <p>
                  Stellar_Card provides an HTTP + SDK interface that lets you create a Visa prepaid
                ...
                <p>
                  Stellar_Card is <strong>not</strong> a bank, not a money services business, and not a
            ...
            body: (
              <>
                <p>
                  ...
                  sanctions. You must not use Stellar_Card to issue cards to any sanctioned person or
                  entity.
                </p>
                <p>
                  If you&apos;re using Stellar_Card on behalf of a company, you warrant that you have
          ...
          },
          {
            ...
            body: (
              <>
                <p>You agree not to use Stellar_Card to:</p>
                <ul>
            ...
            body: (
              <>
                ...
                <p>
                  ...
                  agents. Stellar_Card provides the claim-code flow specifically for this reason.
                </p>
              </>
            ),
          },
          {
            ...
            body: (
              <>
                <p>
                  Stellar_Card sells cards at face value — you pay exactly the stated USD amount in USDC
                ...
                <p>
                  ...
                  Stellar_Card. The card can still be spent, and the cardholder (you or your agent) owns
          ...
          },
          {
            ...
            body: (
              <>
                <p>
                  Stellar_Card aims for 99.9% monthly uptime on the HTTP API. We publish status and
                  incident postmortems at{' '}
                  <a href="https://status.stellar_card.com">status.stellar_card.com</a>. Scheduled
                ...
                <p>
                  ...
                  experiences an outage, Stellar_Card order fulfilment may stall until upstream
            ...
            body: (
              <>
                <p>
                  ...
                  maximum extent permitted by law, Stellar_Card disclaims all warranties, express or
                  implied, including merchantability, fitness for a particular purpose, and
                  non-infringement.
                </p>
                <p>
                  Stellar_Card is not responsible for the behaviour of any agent or program you build on
          ...
          },
          {
            ...
            body: (
              <>
                <p>
                  To the maximum extent permitted by law, Stellar_Card&apos;s total liability for any
                  claim arising out of or relating to the service is limited to the fees paid by you
                  to Stellar_Card in the twelve months preceding the claim.
                </p>
                <p>
          ...
          },
          {
            ...
            body: (
              <>
                <p>
                  Legal questions: <a href="mailto:legal@stellar_card.com">legal@stellar_card.com</a>.
                </p>
              </>
            ),
          },
