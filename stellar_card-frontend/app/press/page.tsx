...
export const metadata: Metadata = {
  title: 'Press',
  description:
    'Press, media, and podcast inquiries for Stellar_Card. Contact, press kit, quick facts, and expert quotes on agent payments.',
  alternates: { canonical: 'https://stellar_card.com/press' },
  openGraph: ogForPage({
    title: 'Press — Stellar_Card',
  ...
  return (
    <>
      <PageHero
        ...
        accent="talk"
        intro="Stellar_Card is one of a small number of teams shipping live infrastructure at the intersection of autonomous agents and traditional card rails. We're happy to do on-the-record interviews, background calls, podcast appearances, and expert quotes for anything in our lane."
      />
      ...
      <PageSection eyebrow="Press kit" title="Assets, ready to ship.">
        ...
        >
          Stellar_Card, the Stellar_Card wordmark, and the Stellar_Card mark are trademarks of CTX.com Inc. Use
