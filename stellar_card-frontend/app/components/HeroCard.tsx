...
// ~/code/stellar_cardanimation/index.html with three deltas:
//   - Idle drift dialled back from ±8/±6 to ±2.5/±1.8 per pass.
//   - The brand mark is replaced with a Stellar_Card wordmark rendered
  ...
  return (
    <>
      <div className="hc-card-wrap">
        ...
        <article ref={cardRef} className="hc-card" aria-label="Stellar_Card virtual card">
          ...
          <div className="hc-card-content">
            <header className="hc-topline">
              <span className="hc-brand-wordmark" role="img" aria-label="Stellar_Card" />
...
function CardStyles() {
  return (
    <style>{`
      ...
      /* Stellar_Card wordmark on the card face — SVG mask coloured with cream ink. */
      .hc-brand-wordmark {
