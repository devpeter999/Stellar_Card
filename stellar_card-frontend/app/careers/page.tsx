...
export const metadata: Metadata = {
  title: 'Careers',
  description:
    'Join Stellar_Card. Remote-first, flexible hours, published salaries. Building payment infrastructure for the autonomous agent economy.',
  alternates: { canonical: 'https://stellar_card.com/careers' },
  openGraph: ogForPage({
    title: 'Careers — Stellar_Card',
...
const JOBS = [
  ...
  },
  {
    ...
    body: "Build reference agents on top of Stellar_Card. Ship example MCPs. Run office hours. Write the docs we haven't written yet. You are our feedback loop with the autonomous agent ecosystem.",
  },
  {
    team: 'Security',
...
const REASONS = [
  {
    ...
    body: 'Stellar_Card is small, fast, and agile. You will directly impact the direction of the product and grow with the company from day one.',
  },
  {
...
function buildJobJsonLd(job: (typeof JOBS)[number]) {
  return {
    ...
    hiringOrganization: {
      '@type': 'Organization',
      name: 'Stellar_Card',
      sameAs: 'https://stellar_card.com',
      logo: 'https://stellar_card.com/icon.png',
    },
    ...
    applicationContact: {
      '@type': 'ContactPoint',
      email: 'careers@stellar_card.com',
    },
  };
}
  ...
  return (
    <>
      ...
      <PageHero
        ...
        accent="agents"
        intro="Stellar_Card is small, remote-first, and focused. We publish every salary, we hire from everywhere, and we don’t believe anyone should choose between doing great work and taking care of themselves. Below is what we offer and what we’re currently hiring for."
      />
        ...
        >
          {JOBS.map((j) => (
            ...
            >
              ...
              >
                <a
                  href={`mailto:careers@stellar_card.com?subject=Application: ${encodeURIComponent(j.title)}`}
                  style={{
                    display: 'inline-flex',
                    alignItems: 'center',
                    gap: '0.5rem',
      ...
      <section style={{ padding: '3rem 1.35rem 6rem' }}>
        ...
        >
          ...
          <a
            href="mailto:careers@stellar_card.com?subject=Speculative application"
            style={{
              display: 'inline-flex',
              alignItems: 'center',
              gap: '0.55rem',
